...
class Messaging {
  ...
  async handleIncomingData (msg, thisNode) {
    try {
      // console.log('handleIncomingData() msg.detail: ', msg.detail)
      // console.log(`handleIncomingData() message from ${msg.detail.from.toString()}, sn: ${msg.detail.sequenceNumber}`)
      this.log.statusLog(3, `handleIncomingData() message from ${msg.detail.from.toString()}, sn: ${msg.detail.sequenceNumber}`)
      // console.log('handleIncomingData() msg.detail.data: ', msg.detail.data.toString("hex"))
      ...
      // console.log(`this.privMsgCnt: ${this.privMsgCnt}, from ${from}, sn: ${msg.detail.sequenceNumber}`)
      // this.privMsgCnt++
      // console.log('handleIncomingData() msg.detail: ', msg.detail)
      ...
      // 10/18/23 CT: I'm not sure how to filter encrypted messages from
      // non-encrypted messages. I'm assuming encrypted messages have
      // a payload property.
      if (!data.payload) {
        return false
      }

      // console.log('messaging.js/handleIncomingData() data: ', data)
      // console.log('messaging.js/handleIncomingData() typeof data: ', typeof data)
      ...
      // const rawData = uint8ArrayToString(msg.detail.data)
      // console.log('handleIncomingData() rawData: ', rawData)
